...
💬 /chats - <b>Управление тематическими чатами</b>: Создавайте, переключайтесь, очищайте или удаляйте чаты.
...
Вы успешно переключились на модель MusicGen — удивительный мир, где музыка рождается на ваших глазах. Создайте уникальную мелодию, поделившись своим настроением или идеей для композиции. От классической симфонии до современного бита, MusicGen поможет вам воплотить музыкальные мечты в реальность.
