...
Кажется, вы хотите запросить меньше одной секунды. В мире творчества нужна хотя бы одна, чтобы начать!

🌟 <b>Совет:</b> Введите число больше 0, чтобы начать волшебство!
"""
    MUSIC_GEN_MAX_ERROR = """
🤨 <b>Постойте, партнёр!</b>

Кажется, вы хотите запросить больше 3-х минут, я пока не умею генерировать больше!

🌟 <b>Совет:</b> Введите число меньше 180, чтобы начать волшебство!
"""
...
- {format_number(subscription_limits[Quota.CHAT_GPT4_OMNI_MINI])} картинка, которая нарисует твою фантазию
