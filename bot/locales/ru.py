...
Следите за обновлениями и новыми функциями, все они вдохновлены вами. Мы начислили на ваш баланс 50 кредитов, а пока приятного общения! 🚀
...
"""
    ...
    # Suno
    SUNO_INFO = """
🤖 Выберите стиль создания вашей песни:
...
Дата обновления подписки: {renewal_date}
...
{f'💸 Скидка при покупке подписки: {discount}%' if discount > 0 else ''}
"""
...
💸 За каждого приглашённого пользователя вы получаете 50 кредитов 🪙 на ваш бонусный баланс
🌟 Ваша персональная реферальная ссылка для приглашений:
...
Благодаря вам к нам присоединился новый пользователь, и в знак признательности ваш баланс увеличился на {added_to_balance} кредитов 🪙! Используйте их для доступа к эксклюзивным функциям или пополнения количества генераций в нейросетях 💸
