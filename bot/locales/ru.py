...
class Russian(Texts):
    START = """
<b>Добро пожаловать в мир AI!</b> 🎉

Я - ваш личный помощник в изучении возможностей искусственного интеллекта:

✉️ Общайтесь с <b>ChatGPT</b>, создавайте изображения с <b>DALL-E</b> и <b>Midjourney</b>
😜 Меняйте лица на фото с помощью <b>FaceSwap</b>
🎵 Сочиняйте музыку с <b>MusicGen</b> и <b>Suno</b>
💫 Используйте мощные AI-модели для бизнес-задач

<b>Выберите свою AI-модель с помощью команды /mode.</b>

Введите /help и /info, чтобы узнать все доступные команды.
Я готов помочь вам открыть новые горизонты AI! 🚀
"""
    COMMANDS = """
<b>Исследуйте возможности AI:</b> 🤖

✨ /start - Узнайте обо мне и моих возможностях
🤖 /mode - Переключайтесь между моделями: <b>ChatGPT</b>, <b>Claude</b>, <b>DALL-E</b> и другие
💳 /buy - Оформите подписку или индивидуальные пакеты
👤 /profile - Проверьте детали вашей учетной записи
🔧 /settings - Настройте предпочтения и управляйте чатами
🌍 /language - Выберите предпочтительный язык
ℹ️ /info - Получите информацию о моих моделях
🎁 /bonus - Используйте бонусный баланс для генераций
🔑 /promo_code - Откройте эксклюзивные функции с промокодами
📡 /feedback - Помогите мне стать лучше

<b>Попробуйте команды /chatgpt, /face_swap, /dalle, /midjourney и другие, чтобы начать свое путешествие в мир AI! 🌟</b>
"""
    INFO = """
...
"""
    ...
    REACHED_USAGE_LIMIT = """
<b>Ой-ой! 🚨 Кажется, вы исчерпали квоту на использование этой модели.</b>

Но не волнуйтесь, у нас есть решения:

- Пополните баланс через /buy
- Приглашайте друзей с помощью /bonus
- Переключайтесь на другую модель с /mode

Новые приключения ждут вас! 🚀✨
"""
...
"""
    ...
    # Payment
    BUY = """
🚀 <b>Добро пожаловать в магазин чудес!</b> 🛍

🌟 <b>Подписки: Ваш VIP-доступ к инновациям!</b>
Полный доступ к сервисам: от ChatGPT до уникальных песен. Тематические чаты, быстрые ответы, персонализированные изображения. Выбирайте <b>STANDARD</b> ✨, <b>VIP</b> 🔥 или <b>PREMIUM</b> 💎.

🛍 <b>Пакеты: Решение для ваших задач!</b>
Целевое количество запросов и сервисов. Платите только за использованное.
...
🚀 Как получить фото из интернета с помощью <b>pic?</b>

1) В строке сообщения напишите <b>"@pic фото из интернета"</b>
<b>Пример</b>: "@pic космонавт".
2) Не отправляя сообщение, просмотрите фото, которые появятся в окне <b>над строкой сообщения</b>.
3) Выберите понравившееся фото, <b>нажав</b> на него.
4) <b>Отправьте</b> выбранное фото.

🌈 Отправьте мне фотографию, на котором я заменю лицо на ваше из /profile, <b>выберите пакет</b> ниже или используйте @pic для выбора картинки из интернета 👇
"""
