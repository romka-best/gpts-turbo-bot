...
class Russian(Texts):
    START = """
🤖 <b>Добро пожаловать в будущее ИИ со мной, ChatGPTs Turbo AI Bot</b> 🎉

Я — ваш проводник в мир нейросетей. Откройте для себя безграничные возможности:
━ 💭 <b>Текстовые ответы</b>:
    ...
    ┗ Исследуйте самый продвинутый уровень интеллекта с:
        ┣ <b>ChatGPT o1-preview 🧪</b> /chatgpt
        ┣ <b>Claude 3.0 Opus 🚀</b> /claude
        ┗ <b>Gemini 1.0 Ultra 🛡️</b> /gemini

━ 🖼 <b>Создание изображений</b>:
    ┣ Рисуйте красивые, впечатляющие изображения с:
        ┣ <b>DALL-E 3 👨‍🎨</b> /dalle
        ┣ <b>Midjourney 6.1 🎨</b> /midjourney
        ┣ <b>Stable Diffusion 3.0 🎆</b> /stable_diffusion
        ┗ <b>Flux 1.1 Pro 🫐</b> /flux
    ┣ Чтобы поменяться лицами с кем-то на фото, попробуйте <b>FaceSwap 📷️</b> /face_swap
    ┗ Редактируйте свои изображения с помощью <b>Photoshop AI 🪄</b> /photoshop
...
━ 🖼 <b>Создание изображений</b>:
    ┣ 1️⃣ Введите одну из команд:
        ...
        ┣ /stable_diffusion 🎆
        ┗ /flux 🫐
    ┗ 2️⃣ Дайте волю своему воображению отправляя свои запросы

━ 😜 <b>Смена лиц на фото</b>:
    ┣ 1️⃣ Введите команду /face_swap
    ┣ 2️⃣ Следуйте инструкциям, чтобы ИИ подбирал правильную замену
    ┗ 3️⃣ Выберите изображения из наших уникальных пакетов или отправьте своё
...
━ 🎵 <b>Создание музыки</b>:
    ┣ 1️⃣ Введите одну из команд:
        ┣ /music_gen 🎺
        ┗ /suno 🎸
    ┗ 2️⃣ Напишите описание музыки или отправьте свой собственный текст
"""
    ADDITIONAL_FEATURES = """
🔮 <b>Дополнительные возможности</b>:

━ 🔄 /mode - Одна команда для переключения между нейросетями
...
🧪 <b>ChatGPT o1-preview: Революция в рассуждениях</b>
...
📜 <b>Claude 3.0 Haiku: Искусство краткости и мудрости</b>
...
🏎 <b>Gemini 1.5 Flash: Скорость и эффективность</b>
...
Каждый бросок — победа, но насколько велика она будет? Узнайте прямо сейчас!
"""
...
Готовы рискнуть и проверить, насколько я меткий? Дротик уже в воздухе!
"""
...
Сможете ли вы почувствовать удачу и угадать, какое число выпадет? Бросок — и всё решится!
"""
...
Возвращайтесь и покажите, на что вы способны! 👏
"""
...
"""
    CHOOSE_GEMINI_MODEL = """
Для выбора Gemini модели нажмите на кнопку ниже 👇
"""
    SWITCHED_TO_AI_SETTINGS = "⚙️ Перейти в настройки модели"
    SWITCHED_TO_AI_INFO = "ℹ️ Что умеет модель"
...
💥 <b>Добро пожаловать в мир ChatGPT 4.0 Omni!</b>
...
🧩 <b>Добро пожаловать в мир ChatGPT o1-mini!</b>

Вы успешно переключились на модель <b>ChatGPT o1-mini</b> — это ваш быстрый и точный помощник для решения сложных задач! <b>ChatGPT o1-mini</b> отличается способностью к глубокому анализу и логическим рассуждениям, что делает его идеальным выбором для задач, требующих внимания к деталям и аргументированных выводов. Несмотря на компактность, его интеллектуальные возможности впечатляют.

Погружайтесь в новый уровень AI-взаимодействия с <b>ChatGPT o1-mini</b>! 🎉
"""
    SWITCHED_TO_CHAT_GPT_O_1_PREVIEW = """
🧪 <b>Добро пожаловать в мир ChatGPT o1-preview!</b>

Вы успешно переключились на модель <b>ChatGPT o1-preview</b> — это ваш предвосхищающий будущее помощник, специально созданный для сложных рассуждений и анализа! <b>ChatGPT o1-preview</b> предлагает передовые возможности в области логических решений и научных гипотез, что делает его незаменимым в поиске точных и продуманных ответов.

Откройте новые горизонты с ChatGPT o1-preview! 🎉
"""
    SWITCHED_TO_CLAUDE_3_HAIKU = """
📜 <b>Добро пожаловать в мир Claude 3.0 Haiku!</b>

Вы успешно переключились на модель <b>Claude 3.0 Haiku</b> — мастер краткости и точности. <b>Claude 3.0 Haiku</b> создан для тех случаев, когда вам нужны быстрые, ёмкие и мудрые ответы. Его сила заключается в способности обрабатывать информацию с лаконичной глубиной, идеально подходя для творческих задач и мгновенных решений.

Наслаждайтесь искусством краткости вместе с <b>Claude 3.0 Haiku</b>! 🎉
"""
    SWITCHED_TO_CLAUDE_3_SONNET = """
💫 <b>Добро пожаловать в мир Claude 3.5 Sonnet!</b>

Вы успешно переключились на модель <b>Claude 3.5 Sonnet</b>. Это мастер сбалансированного интеллекта и скорости! Эта модель идеально подходит для выполнения корпоративных задач, сочетая быстроту реакции с глубоким анализом. Ваш опыт будет улучшен благодаря сохранённой истории бесед, позволяющей продолжить диалог без потери контекста.

Новый уровень взаимодействия с <b>Claude 3.5 Sonnet</b>! 🎉
"""
    SWITCHED_TO_CLAUDE_3_OPUS = """
🚀 <b>Добро пожаловать в мир Claude 3.0 Opus!</b>

Вы успешно переключились на модель <b>Claude 3.0 Opus</b>. Это пик технологической мощи для самых сложных задач! Эта модель предлагает безпрецедентную глубину понимания и способность к решению наиболее сложных проблем. Предыдущая история бесед была сохранена, что гарантирует бесшовное продолжение общения.

Приготовьтесь к продвинутому опыту с <b>Claude 3.0 Opus</b>! 🎉
"""
    SWITCHED_TO_GEMINI_1_FLASH = """
🏎 <b>Добро пожаловать в мир Gemini 1.5 Flash!</b>

Вы успешно переключились на модель <b>Gemini 1.5 Flash</b>, созданную для тех, кто ценит скорость и эффективность! Эта модель идеально подходит для выполнения задач, требующих мгновенного анализа и быстрых решений. Мгновенные ответы и лёгкость в работе — вот что вас ждёт с <b>Gemini 1.5 Flash</b>!

Готовьтесь к стремительным результатам и новому уровню продуктивности! 🎉
"""
    SWITCHED_TO_GEMINI_1_PRO = """
💼 <b>Добро пожаловать в мир Gemini 1.5 Pro!</b>

Вы успешно переключились на модель <b>Gemini 1.5 Pro</b> — мощный инструмент для решения сложных задач! Эта модель идеально подходит для глубокого анализа, работы с большими объемами данных и точных решений. Максимальная производительность и интеллектуальные возможности теперь в вашем распоряжении!

Ощутите профессиональный уровень с <b>Gemini 1.5 Pro</b>! 🎉
"""
    SWITCHED_TO_GEMINI_1_ULTRA = """
🛡 <b>Добро пожаловать в мир Gemini 1.0 Ultra!</b>

Вы успешно переключились на модель <b>Gemini 1.0 Ultra</b> — ваш мощный союзник для самых сложных и амбициозных задач! <b>Gemini 1.0 Ultra</b> — это высшая точка интеллектуальной мощности, готовая справиться с глубокими исследованиями, точными вычислениями и творческими вызовами на самом высоком уровне.

Откройте новый уровень взаимодействия с Gemini 1.0 Ultra! 🎉
"""
    SWITCHED_TO_DALL_E = """
...
🎆 <b>Добро пожаловать в мир Stable Diffusion 3.0!</b>

Вы успешно переключились на модель <b>Stable Diffusion</b> — идеальный инструмент для создания уникальных изображений! Эта модель позволяет вам воплощать в жизнь визуальные идеи с высокой детализацией и разнообразными художественными стилями. Превращайте текст в шедевры, исследуя границы вашего творчества!

Пора творить! 🎉
"""
    SWITCHED_TO_FLUX = """
🫐 <b>Добро пожаловать в мир Flux 1.1 Pro!</b>

Вы успешно переключились на модель <b>Flux</b> — мощный инструмент для создания бесконечных вариаций изображений. Flux предлагает вам свободу экспериментов, позволяя исследовать разные стили, формы и концепции без ограничений. Используйте случайность и тонкие настройки для получения непредсказуемо креативных результатов!
...
🪄 <b>Добро пожаловать в мир Photoshop AI!</b>

Вы успешно переключились на модель <b>Photoshop AI</b> — вашего личного мастера фото-магии! <b>Photoshop AI</b> способен восстанавливать старые фотографии, оживлять черно-белые изображения цветом и мгновенно удалять фон с ваших снимков. Воспользуйтесь мощью интеллектуального редактирования прямо сейчас!
...
Твоя сегодняшняя квота на использование этой модели исчезла как фокусник Худини! 🎩

❗️Но не переживай, у нас есть решение:
"""
...
🌟 <b>Совет:</b> Введите число больше меньше 300, чтобы начать волшебство. Давайте выпустим на волю творческие идеи!
"""
    SECONDS_30 = "🔹 30 секунд"
    SECONDS_60 = "🔹 60 секунд (1 минута)"
    SECONDS_180 = "🔹 180 секунд (3 минуты)"
    SECONDS_240 = "🔹 240 секунд (4 минуты)"
...
"""
    ...
    CLAUDE_3_HAIKU_REQUESTS = "📜 Claude 3.0 Haiku запросы"
    CLAUDE_3_HAIKU_REQUESTS_DESCRIPTION = "Погрузитесь в мир краткости и мудрости с Claude 3.0 Haiku, где лаконичность рождает гениальные идеи! 📜"
    ...
    STABLE_DIFFUSION_REQUESTS = "🎆 Stable Diffusion 3.0 изображения"
...
Что дальше?
- 📷 Отправь нам фото с лицом, чтобы заменить своё в FaceSwap!
...
🔄 <i>Лимит обновится через: {hours_before_limit_update} ч. {minutes_before_limit_update} мин.</i>
"""
...
"""
    ...
    def switched(model: Model, model_version: str):
        if model == Model.CHAT_GPT and model_version == ChatGPTVersion.V4_Omni_Mini:
            ...
            return Russian.SWITCHED_TO_STABLE_DIFFUSION
        elif model == Model.FLUX:
            return Russian.SWITCHED_TO_FLUX
        elif model == Model.FACE_SWAP:
            return Russian.SWITCHED_TO_FACE_SWAP
        elif model == Model.PHOTOSHOP_AI:
            return Russian.SWITCHED_TO_PHOTOSHOP_AI
