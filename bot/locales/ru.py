...
🤖 /mode - <b>Переключение модели нейросетей</b> на лету — <b>ChatGPT-3.5</b>, <b>ChatGPT-4.0</b>, <b>DALL-E 3</b>, <b>FaceSwap</b> или <b>MusicGen</b>!
...
Вы успешно переключились на модель <b>DALLE-3</b> — это ваш личный художник AI. Теперь вы можете просить нарисовать любое изображение, которое только придёт вам в голову. Просто опишите свою идею одним сообщением, и <b>DALLE-3</b> превратит её в визуальное творение. Обратите внимание: каждое новое сообщение будет обрабатываться отдельно, контекст предыдущих запросов не учитывается
...
✉️ <b>ChatGPT-3.5</b>
Запросов на месяц: {monthly_limits[Quota.GPT3]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.GPT3]}
Дополнительные запросы: {additional_usage_quota[Quota.GPT3]}

🧠 <b>ChatGPT-4.0</b>
Запросов на месяц: {monthly_limits[Quota.GPT4]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.GPT4]}
Дополнительные запросы: {additional_usage_quota[Quota.GPT4]}

🖼 <b>DALL-E 3</b>
Изображений на месяц: {monthly_limits[Quota.DALLE3]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.DALLE3]}
Дополнительные изображения: {additional_usage_quota[Quota.DALLE3]}
...
- <b>Standard</b> ⭐: Всего за {prices[SubscriptionType.STANDARD]} окунитесь в мир ИИ! Идеально для ежедневных размышлений, творческих вспышек и моментов любопытства. Общайтесь вовсю с ChatGPT-3.5, создавайте изображения из воздуха с DALLE-3 и меняйте лица быстрее, чем вы скажете "сыр"! 🧀
...
- <b>Platinum</b> 💎: Для ценителей, {prices[SubscriptionType.PLATINUM]} предоставляют ключи от королевства ИИ! Максимизируйте запросы ChatGPT-4.0, создавайте тематические чаты и получайте эксклюзивный доступ к последним инновациям в области ИИ. Это всё, что вы можете себе представить от ИИ, и даже больше! 🍽️
...
"""
    ...
    def settings(human_model: str, current_model: Model, dalle_cost=1) -> str:
        if current_model == Model.GPT3 or current_model == Model.GPT4:
            additional_text = f"\n<b>Версия ChatGPT-3.5</b>: {Model.GPT3}\n<b>Версия ChatGPT-4.0</b>: {Model.GPT4}"
        elif current_model == Model.DALLE3:
            additional_text = f"\nПри текущих настройках 1 запрос стоит: {dalle_cost} 🖼"
        else:
            additional_text = ""
