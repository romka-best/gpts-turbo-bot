...
class Russian(Texts):
    START = """
🤖 <b>Добро пожаловать в будущее искусственного интеллекта с ChatGPTsTurboBot</b> 🎉
...
🤖 /mode - <b>Переключение модели нейросетей</b> на лету — <b>ChatGPT-3.5</b>, <b>ChatGPT-4.0</b>, <b>DALL-E</b>, <Midjourney>, <b>FaceSwap</b> или <b>MusicGen</b>!
...
- <i>Кастомные иллюстрации</i>: Создание уникальных персонажей и сценариев для ваших проектов и презентаций.
- <i>Прототипирование продуктов</i>: Визуализация идей новых продуктов, от эскизов до полноценных концептов.
...
<i>Музыка для каждого момента</i>: Специально созданные композиции для релаксации, учебы, тренировок или медитации.
...
Но не расстраивайтесь! Вы всё ещё можете изучать наши другие волшебные предложения с помощью /buy. В нашем мире ИИ всегда есть что-то увлекательное! 🎩✨
...
Но не беспокойтесь! Вы можете ознакомиться с нашими последними предложениями в /buy. У нас всегда есть что-то новое в запасе! 🎉🔮
...
Чтобы разблокировать чудо преобразования голоса в текст, просто воспользуйтесь волшебством команд /buy.
...
Ты можешь возобновить свой магический доступ с помощью /buy и продолжить исследование вселенной ИИ или, если хочешь, выбрать индивидуальные пакеты, созданные специально для тебя 🎁
...
🎁 Хотите продолжить? Посмотрите наши предложения в /buy. Впереди ещё много увлекательных моментов!
...
Перейдите в /buy, чтобы разблокировать возможность вести несколько чатов. Чем больше чатов, тем веселее! 🎉
"""
...
Чтобы перемещаться между разными тематическими чатами, просто получите ваш пропуск в /buy. Пусть начнется чат-путешествие! 🐇
"""
...
Вы собираетесь стереть все сообщения и очистить контекст этого чата. Это действие невозможно отменить, и все ваши беседы исчезнут в виртуальной пыли. Вы уверены, что хотите продолжить?
...
А что если вместо этого добавить больше чатов в ваше царство? Посмотрите /buy, чтобы построить свою чат-империю! 👑
"""
...
- <b>Standard</b> ⭐: Всего за {prices[SubscriptionType.STANDARD]} окунитесь в мир ИИ!

- <b>VIP</b> 🔥: Есть большие планы? За {prices[SubscriptionType.VIP]} вы откроете для себя более глубокие диалоги, более сложное создание изображений и доступ к более широкому ассортименту цифровых персонажей!

- <b>Platinum</b> 💎: Для ценителей, {prices[SubscriptionType.PLATINUM]} предоставляют ключи от королевства ИИ!

P.S. На данный момент оплата доступна в рублях, так как мы пока находимся в процессе интеграции других валют непосредственно в нашу платформу, но вы можете посетить нашу платежную страницу и произвести оплату в других валютах прямо здесь: https://app.lava.top/ru/gptsturbobot
...
🧠 <b>ChatGPT-3.5 & ChatGPT-4.0</b>: Погрузитесь в глубокие, заставляющие задуматься разговоры. Ваши новые ИИ-друзья уже ждут!

🖼 <b>Волшебство DALL-E</b>: Превращайте идеи в потрясающие визуализации. Это как рисование с помощью ИИ!

🎨 <b>Творчество Midjourney</b>: Воплощайте идеи в невероятные изображения. Сложно отличить от реальных изображений!
...
Нажмите кнопку и отправляйтесь в необыкновенное путешествие с ИИ 🌌️
"""
...
🌠 <b>Доступные генерации</b>: {available_images} изображений. Нужно больше? Ознакомьтесь с /buy!
...
💸 За каждого приглашённого пользователя вы получаете 50₽ на ваш бонусный баланс
...
Благодаря вам к нам присоединился новый пользователь, и в знак признательности ваш баланс увеличился на {added_to_balance}! Используйте их для доступа к эксклюзивным функциям или пополнения количества генераций в нейросетях 💸
