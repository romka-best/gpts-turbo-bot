...
✉️ Общайтесь с <b>ChatGPT-3.5 Turbo/4.0 Turbo/4.0 Omni</b>: задавайте вопросы, получайте ответы
😜 Попробуйте <b>FaceSwap</b>, чтобы поменяться лицами с кем-то на фото
🖼 Рисуйте красивые изображения с <b>DALL-E</b> и <b>Midjourney</b>
🎵 Сочиняйте оригинальные мелодии с <b>MusicGen</b> и пишите свои песни с <b>Suno</b>
💫 Идеальное сочетание скорости и интеллекта для бизнес-задач с <b>Claude 3 Sonnet/Claude 3 Opus</b>

🚀 Нажмите /mode чтобы выбрать вашу AI модель.

Введите /help и /info, чтобы увидеть все доступные команды ИИ.
Я здесь, чтобы стать вашим вторым пилотом! 🚀
"""
    COMMANDS = """
🤖 <b>Вот, что вы можете исследовать:</b>

👋 /start - <b>Обо мне</b>: Узнайте, что я могу сделать для вас
🤖 /mode - <b>Переключение модели нейросетей</b>: ChatGPT, Claude, DALL-E, Midjourney, FaceSwap, MusicGen или Suno
💳 /buy - <b>Подписка или индивидуальные пакеты</b>: Получите новый уровень
👤 /profile - <b>Ваш профиль</b>: Проверьте детали подписки или квоту использования
🔧 /settings - <b>Настройка моделей</b>: Выбор цифрового сотрудника и управление тематическими чатами
🌍 /language - <b>Смена языка</b>: Выберите предпочтительный язык
ℹ️ /info - <b>Информация про модели ИИ</b>: Узнайте для чего они и зачем
🎁 /bonus - Узнайте о бонусном балансе и <b>обменяйте его на уникальные пакеты генераций</b>
🔑 /promo_code - <b>Эксклюзивные функции ИИ</b> и специальные предложения с промокодом
📡 /feedback - <b>Обратная связь</b>: Помогите мне стать лучше

🧠 /chatgpt - <b>Общение с ChatGPT</b>: Получайте продвинутые AI-ответы
🚀 /claude - <b>Общение с Claude</b>: Исследуйте глубину ответов от Claude
🖼 /dalle - <b>Рисование с DALL-E</b>: Превращение идей в рисунки
🎨 /midjourney - <b>Творчество с Midjourney</b>: Воплощение мыслей в изображения
😜 /face_swap - <b>Развлечение с FaceSwap</b>: Поменяйтесь лицами на фото
🎵 /music_gen - <b>Мелодии с MusicGen</b>: Создание музыки без авторских прав
🎸 /suno - <b>Песни с Suno</b>: Создание собственной песни с вашим текстом и разными жанрами
...
<i>Идеально подходит для разнообразных разговоров, образовательной помощи, личного тренера, творческого написания, путешествий и бизнес-помощника.</i>

🧠 <b>ChatGPT-4.0 Turbo</b>:
<i>Помогает с глубоким анализом, решением проблем, языковой экспертизой, консультациями по творчеству и персонализированными рекомендациями.</i>

💥 <b>ChatGPT-4.0 Omni</b>:
<i>Предлагает тщательный анализ, решение сложных задач, мастерство языка, креативные идеи и индивидуальные рекомендации.</i>
"""
    INFO_CLAUDE = """
🤖 <b>Вот, что каждая модель может сделать для вас:</b>

🌟 <b>Claude 3 Sonnet:</b>
Исследования, решение задач, языковая помощь, креативные идеи, планирование путешествий.

🚀 <b>Claude 3 Opus:</b>
Сложные исследования, решение проблем, высокий уровень языкового мастерства, поддержка в креативных проектах, персонализированные рекомендации.
"""
    INFO_DALL_E = """
🤖 <b>Вот, что модель может сделать для вас:</b>

🎨 <b>DALL-E: Творческий гений</b>
- <i>По запросу:</i> Уникальные изображения для иллюстраторов и вдохновения.
- <i>Реклама:</i> Привлекательные изображения для соцсетей.
- <i>Образование:</i> Визуализация концепций для обучения.
- <i>Интерьер:</i> Идеи для планировки комнат.
- <i>Мода:</i> Дизайн одежды и модные иллюстрации.
"""
    INFO_MIDJOURNEY = """
🤖 <b>Вот, что модель может сделать для вас:</b>

🎨 <b>Midjourney: Навигатор творчества</b>
- <i>Арт-дизайн:</i> Уникальные шедевры для художников и дизайнеров.
- <i>Архитектура:</i> Концептуальные проекты зданий и планировки.
- <i>Образование:</i> Иллюстрации для обучения.
- <i>Дизайн интерьеров:</i> Визуализация интерьеров от классики до современности.
- <i>Мода и стиль:</i> Разработка модных луков и аксессуаров.
"""
    INFO_FACE_SWAP = """
🤖 <b>Вот, что модель может сделать для вас:</b>

🤡 <b>FaceSwap: Мастер развлечений</b>
- <i>Веселые переосмысления</i>: Исторические эпохи и кинообразы.
- <i>Персонализированные поздравления</i>: Уникальные открытки и приглашения.
- <i>Мемы и контент</i>: Забавные фотографии для соцсетей.
- <i>Цифровые макияжи</i>: Эксперименты с прическами и макияжем.
- <i>Смешение со знаменитостями</i>: Забавные сравнения лица с звездами.
"""
    INFO_MUSIC_GEN = """
🤖 <b>Вот, что модель может сделать для вас:</b>

🎶 <b>MusicGen: Ваш личный композитор</b>
- <i>Уникальные мелодии</i>: Идеи в музыку любого жанра.
- <i>Персонализированные звуки</i>: Звуковые дорожки для видео, игр и презентаций.
- <i>Исследование стилей</i>: Эксперименты с жанрами и звуками.
- <i>Обучение и вдохновение</i>: Знания о музыке через создание.
- <i>Мгновенное создание мелодий</i>: Текст или настроение становятся музыкой.
"""
    INFO_SUNO = """
🤖 <b>Вот, что модель может сделать для вас:</b>

🎸 <b>Suno: Профессионал в создании песен</b>
- <i>Текст в песню</i>: Suno переводит ваши слова в мелодии под ваш стиль.
- <i>Персонализированные песни</i>: Уникальные композиции для особых моментов.
- <i>Исследование жанров</i>: Эксперименты с музыкой.
- <i>Музыкальное образование</i>: Учимся через практику.
- <i>Быстрое создание музыки</i>: Эмоции становятся песней.
"""
...
Привет! Ваш отзыв для нас как золото 💬✨

- Расскажите, что вам нравится в нашем боте.
- Предложения по функциям? Мы слушаем!
- Есть проблемы? Мы их исправим 🐞

Просто отправьте нам свои мысли. Ваши идеи помогают нам становиться лучше каждый день. Помните, ваше мнение важно для нас! 💌
"""
    FEEDBACK_SUCCESS = """
🌟 <b>Обратная связь получена!</b> 🌟

Спасибо за ваш отзыв! 💌
Ваше мнение - наш секретный ингредиент успеха. Мы работаем над улучшениями, и ваш отклик - ключевой элемент 🍳🔑

Следите за обновлениями и новыми функциями, они вдохновлены вами. 25 кредитов будут начислены на ваш баланс после проверки администраторами. Приятного общения! 🚀
...
- Чёткое селфи с хорошим качеством.
- Одна персона на фото.

👎 <b>Избегайте следующих фотографий:</b>
- Групповые снимки.
- Животные.
- Дети до 18 лет.
- Фото в полный рост.
- Обнажённые или нецензурные изображения.
- Солнцезащитные очки или другие закрывающие лицо предметы.
- Размытые или не в фокусе фото.
- Видео и анимации.
- Сжатые или изменённые изображения.

После подбора идеальной фотографии, <b>загрузите её</b> для начала волшебства 🌟
    """
