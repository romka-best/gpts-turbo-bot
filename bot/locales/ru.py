...
━ 📹 <b>Видеокреатив</b>:
    ┗ Генерируйте видео с <b>Runway Gen-3 Alpha Turbo 🎥</b> /runway
...
━ 📝 <b>Summary</b>:
    ┣ 1️⃣ Введите команду /youtube
    ┗ 2️⃣ Отправьте ссылку на YouTube видео
...
━ 📹 <b>Создание видео</b>:
    ┣ 1️⃣ Введите команду /runway
    ┗ 2️⃣ Напишите описание видео и приложите фотографию
"""
    ADDITIONAL_FEATURES = """
...
━ ИИ команды:
    ┣ 🤖 /mode - <b>Переключение между нейросетеми</b> на лету — <b>ChatGPT</b>, <b>Claude</b>, <b>Gemini</b>, <b>YouTube Резюме</b>, <b>DALL-E</b>, <b>Midjourney</b>, <b>Stable Diffusion</b>, <b>FaceSwap</b>, <b>Photoshop AI</b>, <b>MusicGen</b> или <b>Suno</b>!
    ...
    ┣ 👀 /youtube - <b>Суммаризация в YouTube</b>: Пришлите ссылку на видео и получите резюме
...
- <i>Создание коротких видеороликов</i>: Опишите идею или сценарий, и Runway создаст уникальный видеоклип.
...
❗️Но не переживай, у меня есть решение:
"""
...
"""
    ...
    SUNO_EXAMPLE = "☝️ Вот такую песню на ваш запрос сочинил бы <b>Suno 🎸</b>"
...
"""
    ...
    ┗ 🗯 Тип отправки: {Russian.DOCUMENT if model_info.get(UserSettings.SEND_TYPE, SendType.VIDEO) == SendType.DOCUMENT else Russian.VIDEO}"""
        ...
        return f"""
🔄 <b>Вы успешно переключились на модель {model_name}</b>

{facts}

⬇️ Используйте кнопки ниже, чтобы исследовать больше:
"""
