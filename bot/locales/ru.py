...
✉️ Общайтесь с <b>ChatGPT-3.5</b>: задавайте вопросы, получайте ответы
🧠 Исследуйте продвинутый уровень интеллекта с <b>ChatGPT-4.0</b>
...
✉️ Чтобы получить текстовый ответ от <b>ChatGPT-3.5</b>, просто введите ваш запрос в чат
🧠 Чтобы получить текстовый ответ от <b>ChatGPT-4.0</b>, введите команду /chatgpt, выберите ChatGPT-4.0 и затем просто напишите ваш запрос в чат
...
🤖 /mode - <b>Переключение модели нейросетей</b> на лету — <b>ChatGPT-3.5</b>, <b>ChatGPT-4.0</b>, <b>DALL-E</b>, <b>Midjourney</b>, <b>FaceSwap</b> или <b>MusicGen</b>!
...
🧠 /chatgpt - <b>Общение с ChatGPT-3.5 и ChatGPT-4.0</b>: Начните текстовый диалог и получайте продвинутые AI-ответы.
...
🎁 /bonus - Узнайте о вашем бонусном балансе, пригласите друзей и <b>обменяйте бонусы на уникальные пакеты генераций</b>.
...
✉️ <b>ChatGPT-3.5: Всесторонний коммуникатор</b>
...
- <i>Творческий писатель</i>: Нужен пост, история или даже песня? ChatGPT-3.5 создаст это за секунды.
...
🧠 <b>ChatGPT-4.0: Расширенный интеллект</b>
...
Следите за обновлениями и новыми функциями, все они вдохновлены вами. Мы начислим на ваш баланс 50 кредитов после того, как администраторы проверят содержание обратной связи, а пока приятного общения! 🚀
...
В знак признательности ваш баланс увеличился на 50 кредитов 🪙! Используйте их для доступа к эксклюзивным функциям или пополнения количества генераций в нейросетях 💸
...
🤖 <b>Добро пожаловать в мир ChatGPT-3.5!</b>

Вы успешно переключились на модель <b>ChatGPT-3.5</b>. Это ваш персональный виртуальный мозг, готовый обрабатывать все ваши вопросы и идеи. Пишите что угодно - от простых вопросов до сложных задач. И не волнуйтесь, ваши предыдущие разговоры сохранены в памяти, так что контекст вашего диалога не потеряется

Вперёд, исследуйте возможности <b>ChatGPT-3.5</b>! 🎉
"""
    SWITCHED_TO_CHATGPT4 = """
🚀 <b>Добро пожаловать в мир ChatGPT-4.0!</b>

Вы успешно переключились на модель <b>ChatGPT-4.0</b>. Это настоящий прорыв в мире нейросетей! <b>ChatGPT-4.0</b> обладает более глубоким пониманием и расширенными возможностями в сравнении с предыдущими версиями. Откройте для себя новые горизонты общения с AI. Ваши предыдущие беседы не забыты, и история контекста сохранена

Начните своё путешествие в будущее с <b>ChatGPT-4.0</b>! 🎉
"""
    SWITCHED_TO_DALL_E = """
...
"""
    ...
    # Examples
    CHATGPT4_EXAMPLE_FIRST_PART = "👇 Вот так ответил бы на ваш запрос *ChatGPT-4.0* 🧠"
    CHATGPT4_EXAMPLE_LAST_PART = "Чтобы переключиться на *ChatGPT-4.0*, просто введите команду /chatgpt и выберите *ChatGPT-4.0* 🧠"
    MIDJOURNEY_EXAMPLE = """
...
⚠️ Отправка фотографий доступна только в версии <b>ChatGPT-4.0</b> 🧠

Чтобы переключиться на <b>ChatGPT-4.0</b>, просто введите команду /chatgpt и выберите <b>ChatGPT-4.0</b> 🧠
"""
...
Тут вы - художник, а настройки - ваша палитра. Выберите ниже модель, которую вы хотите настроить под себя 👇
"""
...
Получите полный доступ ко всему спектру инновационных сервисов: от бесед с ChatGPT до создания уникальных мелодий с MusicGen. Используйте тематические чаты, чтобы углубляться в интересующие вас темы и расширять горизонты каждый день. Откройте для себя комфорт быстрых ответов и уникальность персонализированных изображений с FaceSwap. Всё это и многое другое ждёт вас в наших подписках: <b>STANDARD</b> ✨, <b>VIP</b> 🔥 или <b>PLATINUM</b> 💎
...
"""
    ...
    GPT3_REQUESTS = "✉️ ChatGPT-3.5 запросы"
    GPT3_REQUESTS_DESCRIPTION = "Разбудите мощь ChatGPT-3.5 для остроумных бесед, умных советов и бесконечного веселья! 🤖✨"
    GPT4_REQUESTS = "🧠 ChatGPT-4.0 запросы"
    GPT4_REQUESTS_DESCRIPTION = "Исследуйте продвинутый интеллект ChatGPT-4.0 для более глубоких открытий и прорывных бесед! 🧠🌟"
...
<b>Тип подписки:</b> {subscription_type} {emojis[subscription_type]}
...
✉️ <b>ChatGPT-3.5</b>
Запросов на месяц: {monthly_limits[Quota.CHAT_GPT3]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.CHAT_GPT3]}
Дополнительные запросы: {additional_usage_quota[Quota.CHAT_GPT3]}

🧠 <b>ChatGPT-4.0</b>
Запросов на месяц: {monthly_limits[Quota.CHAT_GPT4]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.CHAT_GPT4]}
Дополнительные запросы: {additional_usage_quota[Quota.CHAT_GPT4]}

🖼 <b>DALL-E</b>
Изображений на месяц: {monthly_limits[Quota.DALL_E]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.DALL_E]}
Дополнительные изображения: {additional_usage_quota[Quota.DALL_E]}

🎨 <b>Midjourney</b>
Изображений на месяц: {monthly_limits[Quota.MIDJOURNEY]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.MIDJOURNEY]}
Дополнительные изображения: {additional_usage_quota[Quota.MIDJOURNEY]}

📷 <b>FaceSwap</b>
Изображений на месяц: {monthly_limits[Quota.FACE_SWAP]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.FACE_SWAP]}
Дополнительные изображения: {additional_usage_quota[Quota.FACE_SWAP]}

🎵 <b>MusicGen</b>
Секунд для создания мелодий на месяц: {monthly_limits[Quota.MUSIC_GEN]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.MUSIC_GEN]}
Дополнительные секунды для создания мелодий: {additional_usage_quota[Quota.MUSIC_GEN]}

🎸 <b>Suno</b>
Песен на месяц: {monthly_limits[Quota.SUNO]}/{SubscriptionLimit.LIMITS[subscription_type][Quota.SUNO]}
Дополнительные песни: {additional_usage_quota[Quota.SUNO]}

💬 <b>Тематические чаты</b>
Дополнительные чаты: {additional_usage_quota[Quota.ADDITIONAL_CHATS]}

🎭 <b>Цифровые сотрудники</b>
...
🪙 <b>Бонусный баланс:</b> {int(credits)}
Подробности: /bonus

💎 <b>Оформить подписку</b> или <b>приобрести индивидуальные пакеты:</b> /buy
{f'💸 Скидка на подписку: {discount}%' if discount > 0 else ''}
"""
...
🖼 <b>Волшебство DALL-E</b>: Превращайте идеи в потрясающие визуализации!

🎨 <b>Творчество Midjourney</b>: Воплощайте идеи в невероятные реалистичные изображения!

👤 <b>Веселье с заменой лиц</b>: Играйте с идентичностью на изображениях!

🎵 <b>Гармония с MusicGen</b>: Создавайте уникальные мелодии, которые будут принадлежать только вам!

🎸 <b>Креатив с Suno</b>: Создавайте оригинальные песни с вашим текстом и в разных жанрах!
...
"""
    ...
    def settings(human_model: str, current_model: Model, dall_e_cost=1) -> str:
        if current_model == Model.CHAT_GPT:
            additional_text = f"\n<b>Версия ChatGPT-3.5</b>: {GPTVersion.V3}\n<b>Версия ChatGPT-4.0</b>: {GPTVersion.V4}"
        elif current_model == Model.DALL_E:
...
1️⃣ Пригласить друзей:
    - 💸 За каждого приглашённого пользователя вы и ваш друг получаете 50 кредитов 🪙
    - 🌟 Ваша персональная реферальная ссылка для приглашений: https://t.me/GPTsTurboBot?start={user_id}
    - 👤 Вы пригласили: {referred_count}
2️⃣ Оставить обратную связь:
    - 💸 За каждую конструктивную обратную связь вы получаете 50 кредитов 🪙
...
Благодаря вам к нам присоединился новый пользователь, и в знак признательности ваш и баланс друга увеличился на {int(added_to_balance)} кредитов 🪙! Используйте их для доступа к эксклюзивным функциям или пополнения количества генераций в нейросетях 💸
