...
TEXT_SIMPLE_QUOTA = [Quota.CHAT_GPT4_OMNI_MINI, Quota.CLAUDE_3_SONNET, Quota.GEMINI_1_FLASH]
TEXT_ADVANCED_QUOTA = [Quota.CHAT_GPT4_OMNI, Quota.CLAUDE_3_SONNET, Quota.GEMINI_1_PRO]
IMAGE_QUOTA = [Quota.DALL_E, Quota.MIDJOURNEY, Quota.STABLE_DIFFUSION, Quota.FACE_SWAP]
